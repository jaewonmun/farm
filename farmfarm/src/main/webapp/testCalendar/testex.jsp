...
<link rel="stylesheet" href="/testCalendar/homepage.css">
<link rel="stylesheet" href="/testCalendar/board.css">
<link href="/testCalendar/fullcalendar.css" rel="stylesheet">
<link href="/testCalendar/fullcalendar.print.css" rel="stylesheet"
	media="print">
	...
	<div id="warp">
		...
		<div id="footer">
			<div class="copyright">
				...
				<span style="line-height: 18px;"> farmfarm project<br>
					COPYRIGHT© FARMFARM PROJECT ALL RIGHTS RESERVED.<br> <span
					style="color: red;" id="footer_last">※FARMFARM은 크롬 브라우저에 최적화
						되어 있습니다.</span>
				</span>
	...
	<div
		...
		<div id="dlg_timer" style="z-index: 999;"
			...
			<font family="tahoma" style="font-size: 14px; font-weight: bold;">자동
				로그아웃 남은시간</font><br> <font color="red"
				style="font-size: 20px; font-weight: bold; line-height: 2.2em;">166:21</font>
		</div>
		<div class="ui-dialog-buttonpane ui-widget-content ui-helper-clearfix">
			<div class="ui-dialog-buttonset">
				<button type="button"
