...
<%
 /**
  * @Class Name : FarmWeatherRegister.jsp
  * @Description : FarmWeather Register 화면
...
<c:set var="registerFlag" value="${empty farmWeatherVO.mbrId ? '등록' : '수정'}"/>
...
<!-- validator:javascript formName="farmWeatherVO" staticJavascript="false" xhtml="true" cdata="false"/ -->

<script type="text/javaScript" language="javascript" defer="defer">
<!--
/* 글 목록 화면 function */
function fn_egov_selectList() {
   	document.getElementById("detailForm").action = "<c:url value='/farmWeather/FarmWeatherList.do'/>";
   	document.getElementById("detailForm").submit();		
}

/* 글 삭제 function */
function fn_egov_delete() {
   	document.getElementById("detailForm").action = "<c:url value='/farmWeather/deleteFarmWeather.do'/>";
   	document.getElementById("detailForm").submit();		
}
...
function fn_egov_save() {	
	...
	/* TODO Validation기능 보완 */
  	...
  	frm.action = "<c:url value="${registerFlag == '등록' ? '/farmWeather/addFarmWeather.do' : '/farmWeather/updateFarmWeather.do'}"/>";
    frm.submit();
...
<form:form commandName="farmWeatherVO" name="detailForm" id="detailForm" >
<div id="content_pop">
	<!-- 타이틀 -->
	<div id="title">
		<ul>
	...
	<table width="100%" border="1" cellpadding="0" cellspacing="0" >
	   ...
	   <tr>
			<th>MBR_ID *</th>
			<td>
				<form:input path="mbrId" cssClass="essentiality" readonly="true" />
			</td>			
		</tr>	
		</c:if>
	   ...
	   <tr>
			<th>MBR_ID *</th>
			<td>
				<form:input path="mbrId" cssClass="txt" readonly="false" />
			</td>			
		</tr>	
		</c:if>		
		<tr>
