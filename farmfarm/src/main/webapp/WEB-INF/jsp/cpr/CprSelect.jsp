...
function selectRes() {
	opener.document.getElementById("userConame").value = document.getElementById("CPR").value;//자바스크립트 방식        앞쪽과 같다 $("#CPR option:selected").val()
	opener.document.getElementById("co_name").value = $("#CPR option:selected").text();//jQuery 방식
}
</script>
</head>
<body>
