...
<style>
hr { border-bottom-color: lightgray; }
#weather {	width: 700px; margin: 0 auto; }
#todayWeather { height: 200px; }
#todayTable, #weekTable { margin: 0 auto; }
#dayWt01_1,#dayWt01_2,#dayWt01_3 { padding: 3px; }
#dayWt01_1, .weekWt02, #dayWt01_3 { text-align: center; }
.dayWt01 { border: 1px solid lightgray; border-radius: 5px; height: 150px; }
#dayWt01_1 { border-right-style: none} #dayWt01_2 { border-left-style: none; }
.dayImage { width:120px; height:120px; }
.tomorrowImage {width:50px; height:50px;};
#weekWeaher { border: 1px solid lightgray; border-radius: 5px; height: 200px; }
.weekWt01 { background-color: WhiteSmoke; }
.weekWt02 { border: 1px solid lightgray; border-radius: 5px; height: 130px; margin: 15px; padding:5px; font-size: 12px;}
span, b { margin: 5px; line-height:2.0em; }
.weekImage { width:30px; height:30px; }
.chartDiv { width : 700px; height: 120px; border: 1px solid lightgray; border-radius: 5px; }
</style>
<script src="https://code.jquery.com/jquery-1.12.4.js"></script>
<%-- <script src="<c:url value='/js/weather/weatherSK.js'/>"></script> --%>
...
<body>
	...
	<div id="weather">
		<a id="googleKML" href="${pageContext.request.contextPath}/weather/googleKML.do" style="background-color: AliceBlue">
			<img src="<c:url value='/images/makeImage/logo/rader.png' />" width="155" height="45">
		</a>
	<!-- 현재 날씨 -->
			...
			<table id="todayTable">
				...
				<tbody>
					<tr>
						...
						<td id="dayWt01_3" class="dayWt01"></td>
					</tr>
				</tbody>
			</table>
		</div>
		<hr>
	<!-- 주간 날씨 -->
		<div id="weekWeaher" class="tableWt">
			<table id="weekTable" style="width:100%;">
				<caption><b style="color:#0099ff;">주간 예보</b></caption>
				<colgroup>
					<col style="width: 16%;">
					<col style="width: 16%;">
					<col style="width: 16%;">
				...
				<thead>
					<tr >
						<th class="weekWt01"><strong>Day+2</strong></th>
						<th class="weekWt01"><strong>Day+3</strong></th>
						<th class="weekWt01"><strong>Day+4</strong></th>
						<th class="weekWt01"><strong>Day+5</strong></th>
						<th class="weekWt01"><strong>Day+6</strong></th>
						<th class="weekWt01"><strong>Day+7</strong></th>
					</tr>
				</thead>
				<tbody>
					<tr>								
						<td id="week2day" class="weekWt02"></td>
						<td id="week3day" class="weekWt02"></td>
						<td id="week4day" class="weekWt02"></td>
						<td id="week5day" class="weekWt02"></td>
						<td id="week6day" class="weekWt02"></td>
						<td id="week7day" class="weekWt02"></td>
					</tr>				
				</tbody>
			</table>
			<div id="Nwagon" class="chartDiv"></div>			
		</div>
	</div>
</body>
</html>