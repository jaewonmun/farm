package egovframework.farm.farmdic.web;
...
/*    @RequestMapping("/farmdic/FarmDic.do")
    public String selectFarmDic() {
        return "/farmdic/FarmDic";
    }*/
    
    @RequestMapping("/farmdic/FarmDic1.do")
    public String testFarmDic() {
        return "/farmdic/FarmDic";
    }
