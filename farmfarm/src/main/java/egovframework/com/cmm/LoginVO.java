...
public class LoginVO implements Serializable{
	...
	public String toString() {
		return "LoginVO [id=" + id + ", name=" + name + ", ihidNum=" + ihidNum
				+ ", email=" + email + ", password=" + password
				+ ", passwordHint=" + passwordHint + ", passwordCnsr="
				+ passwordCnsr + ", userSe=" + userSe + ", orgnztId="
				+ orgnztId + ", orgnztNm=" + orgnztNm + ", uniqId=" + uniqId
				+ ", url=" + url + ", ip=" + ip + ", dn=" + dn + "]";
	}
